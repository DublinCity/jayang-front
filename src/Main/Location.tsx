	...
	return (
		<>
			<LocationWrapper id="location">
				<LocationTitle fontSize='2rem' textAlign='center' fontWeight="600">오시는 길</LocationTitle>
				...
				<HowToCome>
					<Method>
						...
						<MethodDesc textAlign="center">
							<StyledDiv textAlign='right' fontWeight="500">버스</StyledDiv>
							<StyledDiv textAlign='right' fontWeight="300">
								건대입구역 마을버스 05번<br /> (강변역행) <br />
					...
					<Method>
						...
						<MethodDesc textAlign="center">
							<StyledDiv textAlign='right' fontWeight="500">지하철</StyledDiv>
							<StyledDiv textAlign='right' fontWeight="300">
								2호선 건대입구역 5번 출구<br />
								7호선 건대입구역 4번 출구 <br />
							</StyledDiv>
					...
					<Method>
						...
						<MethodDesc textAlign="center">
							<StyledDiv textAlign='right' fontWeight="500">주차</StyledDiv>
							<StyledDiv textAlign='right' fontWeight="300">
								교회 (신관 1층, 지하 1-2층)<br />
								뚝섬유원지 (한강둔치)<br />
